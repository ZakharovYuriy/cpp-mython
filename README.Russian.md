...
# Паны по доработке:
1. Добавить UI<br>
2. Добавить возможность чтения документов из файлов<br>
3. Добавить поддержку дробных чисел<br>
4. Добавить больше арифметическмх действий<br>

# Стек технологий:
1. ООП<br>
2. Abstract Syntax Tree (AST).<br>
3. Наследование<br>
4. Таблица виртуальных методов<br>
5. Лексический анализатор, или лексер.<br>
6. Синтаксический анализатор, или парсер.<br>
7. Семантический анализатор.<br>
...
В Mython операция сложения кроме чисел и строк применима к объектам классов со специальным методом **__add__** [пример 6](# 6. Пример операции сложения объектов классов со специальным методом **__add__**:)<br>
...
Функция **str** преобразует переданный ей аргумент в строку. Если аргумент — объект класса, она вызывает у него специальный метод **__str__** и возвращает результат. Если метода **__str__** в классе нет, функция возвращает строковое представление адреса объекта в памяти. Примеры:<br>
 ...
 [пример 8](8. Пример класса с методом __str__:)<br>
...
```
### 11. Пример сеантики присваивания:
